...
import ProjectsByBudget from '../components/ProjectsByBudget';
import ExploreByBuilders from '../components/ExploreByBuilders';
import ExploreByPropertyType from '../components/ExploreByPropertyType';
            ...
            <div className="text-center mb-12">
              <div className="flex justify-center items-center space-x-4 mt-12">
                ...
                <div className="relative">
                  <select className="appearance-none bg-white text-gray-800 px-6 py-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent text-lg pr-10">
                ...
                <div className="relative flex-grow max-w-xl">
                  <input
                    ...
                    className="w-full px-6 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent text-lg text-gray-800"
                  />
                  <button className="absolute right-0 top-0 h-full px-6 bg-teal-700 text-white rounded-r-lg flex items-center space-x-2 hover:bg-teal-800 transition-colors duration-200">
